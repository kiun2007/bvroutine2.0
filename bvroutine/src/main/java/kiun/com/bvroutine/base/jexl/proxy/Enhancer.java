...
import kiun.com.bvroutine.base.jexl.dx.Code;
import kiun.com.bvroutine.base.jexl.dx.Comparison;
import kiun.com.bvroutine.base.jexl.dx.DexMaker;
import kiun.com.bvroutine.base.jexl.dx.FieldId;
import kiun.com.bvroutine.base.jexl.dx.Label;
import kiun.com.bvroutine.base.jexl.dx.Local;
import kiun.com.bvroutine.base.jexl.dx.MethodId;
import kiun.com.bvroutine.base.jexl.dx.TypeId;
...
public class Enhancer {
	...
	public Object create() {
		...
		try {
			...
			return obj;
		} catch (IllegalAccessException | InstantiationException | ClassNotFoundException | IOException mE) {
			mE.printStackTrace();
		}
	...
	private Collection<Method> findAllMethod(){
		Map<String, Method> methods = new HashMap<>();
		for (Class clz = superclass; !Object.class.equals(clz); clz = clz.getSuperclass()) {
			for (Method method : clz.getDeclaredMethods()){
				if (Modifier.isPublic(method.getModifiers()) &&
					...
					if (method.getParameterTypes() != null){
						...
						hasCode = Arrays.hashCode(types);
					}
					methods.put(method.getName() + hasCode, method);
				}
			}
		}
	...
	private <S> void generateFieldsAndMethods(DexMaker dexMaker, TypeId<?> superType, TypeId<S> subType) {
		...
		Collection<Method> methods = findAllMethod();
