...
package kiun.com.bvroutine.base.jexl.dx.rop.cst;
...
public final class CstArray extends Constant {
     ...
     */
    public static final class CstList
            extends FixedSizeList implements Comparable<CstList> {
        /**
         ...
         */
        public CstList(int size) {
            super(size);
        }

        /** {@inheritDoc} */
        public int compareTo(CstList other) {
            int thisSize = size();
