...
public abstract class AMapActivity<T extends ViewDataBinding> extends RequestBVActivity<T> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        timeHandler = new Handler(getMainLooper()){
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                onLocation(location);
                onLatLng(LatLngUtil.fromGPS(location));
                timeHandler.sendEmptyMessageDelayed(msg.what, msg.what);
            }
        };
    ...
    protected void trackLocation(int timeSpace){
        timeHandler.sendEmptyMessageDelayed(timeSpace, 0);
    }
    ...
    private void startLocation(){
        ...
        AMapLocationUtil.startLocation(getContext(), 10, aMapLocation -> {
            mapInit(aMapLocation);
        }, true);
